...
static void M_VerifyNightmare(int ch)
{
    ...
    G_DeferedInitNew((skill_t)nightmare,_g->epi+1,1);
}
...
void M_ChooseSkill(int choice)
{
    ...
    {
        G_DeferedInitNew((skill_t)choice,_g->epi+1,1);
		M_ClearMenus ();
    }    
}
...
{
  M_StartMessage(ENDGAME,(void *)M_EndGameResponse,true); // Ty 03/27/98 - externalized
}
